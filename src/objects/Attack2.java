 ...
 * @author Randy
 */
public class Attack2 extends GameObject {
    ...
    public Attack2(float x, float y, ObjectId id,Handler handler,Player player) {
        super(x, y, id);
        this.player=player;
    ...
    public void render(Graphics g) {
        g.drawImage(texture.attack[5], (int)x, (int)y, null);
