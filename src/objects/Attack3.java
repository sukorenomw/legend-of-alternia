 ...
 * @author Randy
 */
public class Attack3 extends GameObject {
    ...
    public Attack3(float x, float y, ObjectId id,Handler handler,Player player) {
        super(x, y, id);
        this.player=player;
    ...
    public void render(Graphics g) {
        g.drawImage(texture.attack[2], (int)x, (int)y, null);
