 ...
 * @author Randy
 */
public class Attack4 extends GameObject {
    ...
    public Attack4(float x, float y, ObjectId id,Handler handler,Player player) {
        super(x, y, id);
        this.player=player;
    ...
    public void render(Graphics g) {
        g.drawImage(texture.attack[9], (int)x, (int)y, null);
